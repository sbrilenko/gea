...
var Map = function(){
	...
	(function init(){
		...
		eqInfo = new google.maps.InfoWindow({
			content:"<div><img style='float:left;width:90px;height:68px;' src='../img/vid.jpg'/><div style='width:87px;float:left;'><img style='width:141px;margin-left:47px;' src='../img/logo.png'/></div><div style='clear:both;'></div><div style='font-family:Arial;font-size:12px;color:#000;margin-top: 10px;'>г. Донецк, ул. Калинина, 118 (рядом с \"Империя мебели\")<br /><i style='color:#999999;'>+38&nbsp;(062) 304 63 53<br />+38&nbsp;(050) 304 95 82<br /></i> </div> </div>"
		});
